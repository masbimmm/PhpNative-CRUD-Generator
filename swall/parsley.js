...
! function(e, t) {
    ...
    e.extend(!0, O, {
        ...
        defaultMessage: "Harap periksa kembali data yang anda masukan.",
        type: {
            email: "Email tidak valid.",
            url: "This value should be a valid url.",
            number: "Hanya boleh di isi dengan angka.",
            integer: "This value should be a valid integer.",
            digits: "This value should be digits.",
            onlyalpha: "Hanya boleh huruf saja",
            onlynumber: "Hanya boleh Angka saja",
            onlyalphanum: "Hanya boleh huruf dan angka",
            alphanum: "Hanya boleh huruf dan angka dan spasi"
        },
        notblank: "This value should not be blank.",
        required: "Harap di isi.",
        pattern: "Harap periksa kembali data yang anda masukan.",
        min: "This value should be greater than or equal to %s.",
        max: "This value should be lower than or equal to %s.",
        range: "Item hanya boleh di isi dari %s sampai %s.",
