<a href="?deletefunct">delete config</a>
<?php
if (isset($_GET['deletefunct'])) {
  rmdirs("config");
}
            ...
            <div class="panel-body">
              <form class="form-horizontal" action="core/generate.php" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name='host' value="localhost" class="form-control" id="hostname" placeholder="localhost">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name='dbuser' value="root" class="form-control" id="dbuser" placeholder="root">
                  </div>
                </div>
                <div class="form-group">
